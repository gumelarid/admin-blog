...
@section('content')
        ...
        <div class="card-body px-0 pb-2">
            ...
            <form action="{{ url('/dashboard/page/update') }}" method="POST" class="p-3" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="input-group input-group-outline my-3">
                      ...
                      <input type="text" name="title" value="{{ $data->title_page }}"  class="form-control">
                    </div>
